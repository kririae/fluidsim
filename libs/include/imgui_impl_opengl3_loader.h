...
// enums/functions that we use in this source file. Regenerate with: python
// gl3w_gen.py --imgui-dir /path/to/imgui/ see
// https://github.com/dearimgui/gl3w_stripped for more info.
#ifndef __gl3w_h_
#define __gl3w_h_
...
static int open_libgl(void)
{
  ...
  wgl_get_proc_address = (GL3WglGetProcAddr)GetProcAddress(libgl,
                                                           "wglGetProcAddress");
  return GL3W_OK;
}
